...
xst -ifn xst.scr
move Clock48MHZ_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock48MHZ_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock48MHZ_exdes.ucf Clock48MHZ_exdes

echo 'Running map'
map -timing -pr b Clock48MHZ_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Clock48MHZ_exdes -w routed.ncd routed.v
cd ..
